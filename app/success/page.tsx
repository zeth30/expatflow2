    ...
    <div style={{ minHeight: "100vh", background: LIGHT, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "system-ui,Arial,sans-serif", padding: "20px" }}>
      ...
      <div style={{ maxWidth: 400, width: "100%", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginBottom: 40 }}>
          ...
          <span style={{ fontWeight: 800, fontSize: 15, color: INK }}>ReadyExpat <span style={{ color: BLUE }}>Berlin</span></span>
        </div>
        ...
        {status === "error" && (
          <div>
            ...
            <p style={{ color: MUTE, fontSize: 14, marginBottom: 24, lineHeight: 1.6 }}>
              If you were charged, please contact us at <strong>legal@readyexpat.de</strong> with your payment confirmation and we will resolve it immediately.
            </p>
