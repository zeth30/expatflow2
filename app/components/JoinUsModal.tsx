  ...
  return (
    <>
      <style>{`
        ...
        .ju-close:hover{background:#f1f5f9;color:#1a0505}
        ...
        .ju-input:focus{border-color:#cc0000}
        .ju-btn{width:100%;padding:14px;background:#1a0505;color:white;border:none;border-radius:11px;font-size:15px;font-weight:800;cursor:pointer;font-family:inherit;transition:background .15s;margin-top:10px}
        .ju-btn:hover:not(:disabled){background:#cc0000}
        .ju-btn:disabled{opacity:.6;cursor:default}
        .ju-err{color:#e11d48;font-size:13px;margin-top:8px}
        @media(max-width:480px){.ju-card{padding:28px 20px!important}}
      `}</style>
        ...
        <div className="ju-card" onClick={e => e.stopPropagation()}>
          ...
          {status === "done" ? (
            <div style={{ textAlign: "center", padding: "12px 0" }}>
              ...
              <div style={{ fontSize: 20, fontWeight: 800, color: "#1a0505", marginBottom: 8 }}>You&apos;re in.</div>
            ...
            <>
              <div style={{ width: 40, height: 40, borderRadius: 11, background: "linear-gradient(135deg,#1a0505,#cc0000)", display: "grid", placeItems: "center", marginBottom: 18 }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.4">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
                  <polyline points="22,6 12,13 2,6" />
                </svg>
              </div>
              <div style={{ fontSize: 22, fontWeight: 800, color: "#1a0505", letterSpacing: "-0.02em", marginBottom: 8 }}>Stay in the loop</div>
