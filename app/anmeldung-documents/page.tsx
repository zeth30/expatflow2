  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What documents do I need for the Anmeldung in Germany?", acceptedAnswer: { "@type": "Answer", text: "Three documents are always required: a valid passport or EU national ID, the completed Anmeldeformular (all 54 fields in German), and the Wohnungsgeberbestätigung signed by your landlord. Most people should also bring their own birth certificate — particularly if born outside Germany. If you already have a residence permit or visa, bring it — the clerk updates the address printed on it. A permit is not required to register. Married couples need a marriage certificate; families registering children need a birth certificate per child." } },
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 4, name: "Residence permit or visa (non-EU, if you already have one)" },
          ...
          <div className="wrap">
            <div className="kf-grid">
              ...
              <a href="#sec-checklist" className="kf-card kf-gold reveal" style={{ transitionDelay: "160ms" }}>
                ...
                <p className="kf-text">Have a residence permit or visa? Bring it — the clerk updates the address on it.</p>
                <span className="kf-arrow">↗</span>
              </a>
            </div>
          </div>
        ...
        <section className="section" id="sec-checklist">
          <div className="wrap">
            ...
            <div className="reveal" style={{ marginTop: 24, padding: "16px 18px", borderRadius: 14, background: "var(--bg)", border: "1px solid var(--line)", fontSize: 13.5, color: "var(--ink-2)", lineHeight: 1.55 }}>
              <div style={{ marginBottom: 12 }}>Want a fully personalised checklist auto-generated, based on your nationality and situation?</div>
        ...
        <section className="section">
          <div className="wrap">
            ...
            <div className="faq reveal">
              <details><summary>What documents do I need for the Anmeldung in Germany?</summary><div className="ans">Three documents are always required: a valid passport or EU national ID, the completed Anmeldeformular (all 54 fields in German), and the <a href="/wohnungsgeberbestaetigung" style={{ color: "var(--blue)", fontWeight: 600, textDecoration: "none" }}>Wohnungsgeberbestätigung</a> signed by your landlord. Most people should also bring their own birth certificate — particularly if born outside Germany. If you already have a residence permit or visa, bring it — the clerk updates the address printed on it. A permit is not required to register. Married couples need a marriage certificate; families registering children need a birth certificate per child. Use the checklist above to personalise this for your situation.</div></details>
