    ...
    "@graph": [
      ...
      },
      {
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "What happens if I miss the 14-day Anmeldung deadline?", acceptedAnswer: { "@type": "Answer", text: "In Berlin, fines for late registration are extremely rare — and this is by design. Bürgeramt appointments routinely take 3–6 weeks, well beyond the 14-day window. The city is aware. Book the earliest available slot, take a screenshot showing you searched, and keep it. First-time registrants who show up with a complete form and a booking screenshot are not fined." } },
        ...
        <section className="section">
          <div className="wrap">
            ...
            <div className="faq reveal">
              ...
              <details><summary>What happens if I miss the 14-day Anmeldung deadline?</summary><div className="ans">In Berlin, fines for late registration are extremely rare. Bürgeramt appointments routinely take 3–6 weeks — well beyond the 14-day window — and the city knows this. Book the earliest available slot, screenshot the search results showing no earlier availability, and keep it. First-time registrants who show up with a complete form and a booking screenshot are not fined. See <a href="/anmeldung-deadline-berlin" style={{ color: "var(--blue)", fontWeight: 600, textDecoration: "none" }}>the full deadline guide</a> for the complete picture.</div></details>
