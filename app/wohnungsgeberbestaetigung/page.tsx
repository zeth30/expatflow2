...
export default function Wohnungsgeberbestaetigung() {
  ...
  return (
    <div className="shell">
      ...
      <main className="main">
        {/* Hero */}
        <section className="hero" style={{ backgroundImage: "url('/hero-wgb.jpg')" }}>
          <div className="wrap">
        ...
        {/* 04 · Risk scenarios */}
        <section className="section" id="sec-difficult">
          <div className="wrap">
            <div className="section-head reveal">
        ...
        <section className="section">
          <div className="wrap">
            ...
            <div className="faq reveal">
              ...
              <details><summary>How long does the landlord have to provide the Wohnungsgeberbestätigung?</summary><div className="ans">Under §19 BMG, your landlord must provide the form within two weeks of your move-in. Since your own Anmeldung deadline is also 14 days, you effectively need it immediately. If your landlord is slow, request it in writing — your email is evidence that you asked. See the <a href="/anmeldung-documents" style={{ color: "var(--blue)", fontWeight: 600, textDecoration: "none" }}>full document checklist</a> for what else to prepare at the same time.</div></details>
